...
"""
Brain-MRI-PD25-ImageMaskDataset
├─test
│  ├─images
│  └─masks
├─train
...
if __name__ == "__main__":
  try:
    images_dir = "./Brain-MRI-master-PD25/images/"
    masks_dir  = "./Brain-MRI-master-PD25/masks/"
    output_dir = "./Brain-MRI-PD25-ImageMask-Dataset/"
